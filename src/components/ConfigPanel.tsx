        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              className="w-full appearance-none bg-slate-800 border border-slate-700/60 focus:border-indigo-500/80
                         text-slate-100 text-sm font-semibold rounded-xl px-4 py-3 pr-10 outline-none
